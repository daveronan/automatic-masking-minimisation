...
save('RedToBlueDrumsNormalisedMixParametersEQ.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarmEQ(AudioData, x, Qs, FREQs);

audiowrite('RedToBlueDrumsMixedNormalisedEQ.wav', GoodMix, 44100);
audiowrite('RedToBlueDrumsNotMixedNormalisedEQ.wav', BadMix, 44100);
...
audiowrite('RedToBlueGuitarsMixedNormalisedEQ.wav', GoodMix, 44100);
audiowrite('RedToBlueGuitarsNotMixedNormalisedEQ.wav', BadMix, 44100);
