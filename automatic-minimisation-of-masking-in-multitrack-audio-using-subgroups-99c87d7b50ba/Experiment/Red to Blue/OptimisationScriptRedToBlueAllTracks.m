...
load('RedToBlueAllTracksNormalised.mat');
...
save('RedToBlueAllTracksNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('RedToBlueAllTracksMixedNormalised.wav', GoodMix, 44100);
audiowrite('RedToBlueAllTracksNotMixedNormalised.wav', BadMix, 44100);
