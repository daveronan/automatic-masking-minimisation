...
save('LeadMeStemsMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('LeadMeStemsMixed.wav', GoodMix, 44100);
audiowrite('LeadMeStemsNotMixed.wav', BadMix, 44100);
