...
save('NotAloneStemsMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('NotAloneStemsMixed.wav', GoodMix, 44100);
audiowrite('NotAloneStemsNotMixed.wav', BadMix, 44100);
