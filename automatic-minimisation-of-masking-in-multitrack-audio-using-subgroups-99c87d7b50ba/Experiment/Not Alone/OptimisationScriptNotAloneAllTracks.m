...
load('NotAloneAllTracksNormalised.mat');
...
save('NotAloneAllTracksNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('NotAloneAllTracksMixedNormalised.wav', GoodMix, 44100);
audiowrite('NotAloneAllTracksNotMixedNormalised.wav', BadMix, 44100);
