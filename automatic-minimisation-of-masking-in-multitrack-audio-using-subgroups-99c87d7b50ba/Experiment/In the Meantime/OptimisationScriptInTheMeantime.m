...
load('InTheMeantimeDrumsNormalised.mat');
...
save('InTheMeantimeDrumsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('InTheMeantimeDrumsMixedNormalised.wav', GoodMix, 44100);
audiowrite('InTheMeantimeDrumsNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('InTheMeantimeVocalsNormalised.mat');
...
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('InTheMeantimeVocalsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('InTheMeantimeVocalsMixedNormalised.wav', GoodMix, 44100);
audiowrite('InTheMeantimeVocalsNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('InTheMeantimeKeysNormalised.mat');
...
nvars = size(xUB, 1);
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('InTheMeantimeKeysNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('InTheMeantimeKeysMixedNormalised.wav', GoodMix, 44100);
audiowrite('InTheMeantimeKeysNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('InTheMeantimeGuitarsNormalised.mat');
...
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('InTheMeantimeGuitarsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('InTheMeantimeGuitarsMixedNormalised.wav', GoodMix, 44100);
audiowrite('InTheMeantimeGuitarsNotMixedNormalised.wav', BadMix, 44100);
