...
load('InTheMeantimeAllTracksNormalised.mat');
...
save('InTheMeantimeAllTracksNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('InTheMeantimeAllTracksMixedNormalised.wav', GoodMix, 44100);
audiowrite('InTheMeantimeAllTracksNotMixedNormalised.wav', BadMix, 44100);
