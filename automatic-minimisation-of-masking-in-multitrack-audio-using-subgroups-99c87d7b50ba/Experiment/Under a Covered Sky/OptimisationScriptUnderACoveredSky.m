...
load('UnderACoveredSkyDrumsNormalised.mat');
...
save('UnderACoveredSkyDrumsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyDrumsMixedNormalised.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyDrumsNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('UnderACoveredSkyGuitarsNormalised.mat');
...
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('UnderACoveredSkyGuitarsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyGuitarsMixedNormalised.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyGuitarsNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('UnderACoveredSkyVocalsNormalised.mat');
...
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('UnderACoveredSkyVocalsNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyVocalsMixedNormalised.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyVocalsNotMixedNormalised.wav', BadMix, 44100);

clearvars;

load('UnderACoveredSkyKeysNormalised.mat');
...
[x,fval,exitflag] = particleswarm(fun, nvars, xLB, xUB, options)
save('UnderACoveredSkyKeysNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyKeysMixedNormalised.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyKeysNotMixedNormalised.wav', BadMix, 44100);