...
load('UnderACoveredSkyStems.mat');
...
save('UnderACoveredSkyStemsMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyStemsMixed.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyStemsNotMixed.wav', BadMix, 44100);
