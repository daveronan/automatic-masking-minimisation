...
load('UnderACoveredSkyAllTracksNormalised.mat');
...
save('UnderACoveredSkyAllTracksNormalisedMixParameters.mat', 'x', 'fval', 'exitflag');

[BadMix, GoodMix]  = MixAudioEQDRCParticleSwarm(AudioData, x, Qs, FREQs);

audiowrite('UnderACoveredSkyAllTracksMixedNormalised.wav', GoodMix, 44100);
audiowrite('UnderACoveredSkyAllTracksNotMixedNormalised.wav', BadMix, 44100);